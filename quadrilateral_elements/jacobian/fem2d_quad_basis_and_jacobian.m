function [sh, dtm] = fem2d_quad_basis_and_jacobian(qx, qy, x, dtm_only)
% Generate 4 bilinear basis functions' information and the Jacobian determinant 
% on the given quadrature point in a quadrilateral element
